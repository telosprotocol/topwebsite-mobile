      ...
      <ul>
        ...
        <transition name="fade">
          <ul class="sencondList" v-if="aboutShow">
            ...
            <li @click="OpenFAQ" class="fontStyle">FAQ</li>
          </ul>
        </transition>
        ...
        <li @click="showWhiteList()" :class="[navbarPath==='/submitemail'?'hideStyle':'showStyle']">
          <div>WHITEPAPER</div>
          <img src="@/assets/images/xiajiantou.png">
        </li>
        <transition name="fade">
        ...
        <li @click="OpenAmbassador()" :class="[navbarPath==='/ambassador'?'hideStyle':'showStyle']">
          <div>AMBASSADORS</div>
          <img src="@/assets/images/xiajiantou.png">
        </li>
        <!-- <li @click="OpenEvent()">
        ...
        <li @click="showBountyList()">
          <div>BOUNTY</div>
          <img src="@/assets/images/xiajiantou.png">
        </li>
        <transition name="fade">
          <ul class="sencondList" v-if="bountyShow">
            <li class="aboutItem fontStyle" @click="OpenBounty()">Bitcointalk Bounty</li>
            <li class="aboutItem fontStyle" @click="OpenGuide()">Bounty Guide</li>
            <li class="aboutItem fontStyle" @click="OpenANN()">Bitcointalk ANN</li>
            <li @click="OpenLimitedTime()" class="fontStyle">Limited-Time Bounty</li>
          </ul>
        </transition>
