<template>
  <div>
    ...
    <div class="policy">
      ...
      <div class="info">
        <div class="item endmagintop">
            <div class="item-question">General</div>
            <div class="item-ask">
              <p>By accessing and using the TOP Network website (our or this “Website”, “topnetwork.org”), you agree with the following terms of service which may be modified, changed, supplemented or updated from time to time (collectively, these “terms”), as well as all applicable laws and regulations.</p>
              <p>Please read the Terms of Service carefully before you use the Website. Your access to and use of this Website constitutes your acceptance of and agreement to abide by each of the terms set below including our Privacy Policy which is hereby incorporated in these terms. If you are using our Website on behalf of your organization, that organization must accept these terms. If you do not agree with all of these terms, please do not use this Website or any information, links or content contained on this Website. </p>
              <p>We may revise and update these Terms of Service from time to time in our sole discretion. All changes are effective immediately when we post them.</p>
              <p>We suggest that you check this page frequently so you are aware of any changes, as they are binding on you. Your continued use of the Website following the posting of revised Terms of Service means that you accept and agree to the changes. If you do not agree to revised terms, you must stop using this Website and any information, links or content contained on this Website.</p>
            </div>
        </div>
        <div class="item">
            <div class="item-question">Use of Website</div>
            <div class="item-ask">The purpose of our Website is to provide you some general information about TOP Network. You must not breach any of the following terms or our Acceptable Use Policy set out below.</div>
        </div>
        <div class="item">
            <div class="item-question">Third Party Content</div>
            <div class="item-ask">
        ...
        <div class="item">
            ...
            <div class="item-ask">
              ...
              <p>You must immediately update and inform us of any changes to your User Content by updating your personal data by contacting us at legal@topnetwork.org, so that we can communicate with you effectively and provide accurate and up to date information to you.</p>
        ...
        <div class="item">
            ...
            <div class="item-ask">
              ...
              <p>(f) create a false identity for the purpose of misleading others or fraudulently or otherwise misrepresent yourself to be another person or a representative of another entity including, but not limited to, an authorized user of this Website or a TOP Network representative, or fraudulently or otherwise misrepresent that you have an affiliation with a person, entity or group;</p>
              ...
              <p>(r) use this Website to engage in or promote any activity that violates these terms. Indemnification</p>
              <p>To the fullest extent permitted by applicable law, you will indemnify, defend and hold harmless us and our respective past, present and future employees, officers, directors, contractors, consultants, equity holders, suppliers, vendors, service providers, parent companies, subsidiaries, affiliates, agents, representatives, predecessors, successors and assigns (collectively, the “TOP Network Parties”) from and against all claims, damages, liabilities, losses, costs and expenses (including attorneys’ fees) that arise from or relate to: (i) your access to or use of our Website, products or services; (ii) your User Content; (iii) any Feedback you provide; or (iv) your violation of these Terms.</p>
              <p>We reserve the right to exercise sole control over the defence, at your expense, of any claim subject to indemnification pursuant to these terms. This indemnity is in addition to, and not in lieu of, any other indemnities set forth in a written agreement between you and TOP Network.</p>
            </div>
        </div>
        <div class="item">
            <div class="item-question">Disclaimer</div>
            <div class="item-ask">
              ...
              <p>IN NO EVENT WILL THE TOP NETWORK PARTIES BE RESPONSIBLE OR LIABLE FOR ANY CLAIMS, DAMAGES, LIABILITIES, LOSSES, COSTS OR EXPENSES OF ANY KIND, WHETHER DIRECT OR INDIRECT, CONSEQUENTIAL, COMPENSATORY, INCIDENTAL, ACTUAL, EXEMPLARY, PUNITIVE OR SPECIAL (INCLUDING DAMAGES FOR LOSS OF BUSINESS, REVENUES, PROFITS, DATA, USE, GOODWILL OR OTHER INTANGIBLE LOSSES) REGARDLESS OF WHETHER THE TOP NETWORK PARTIES HAVE BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES, LIABILITIES, LOSSES, COSTS OR EXPENSES, ARISING OUT OF OR IN CONNECTION WITH: (A) THE USE OR PERFORMANCE OF THIS WEBSITE; (B) ANY PROVISION OF OR FAILURE TO PROVIDE THIS WEBSITE OR ITS SERVICES (INCLUDING WITHOUT LIMITATION ANY LINKS ON OUR WEBSITE); (C) ANY INFORMATION AVAILABLE FROM THIS WEBSITE; (D) ANY CONDUCT OR CONTENT OF ANY THIRD PARTY; (E) UNAUTHORIZED ACCESS, USE OR ALTERATION OF THE TRANSMISSION OF DATA OR CONTENT TO OR FROM US; OR (F) THE FAILURE TO RECEIVE IN ANY WAY THE TRANSMISSION OF ANY DATA, CONTENT, FUNDS OR PROPERTY FROM YOU. IN NO CIRCUMSTANCES WILL THE AGGREGATE LIABILITY OF THE TOP NETWORK PARTIES ARISING UNDER THESE TERMS EXCEED $5.00 USD.</p>
            </div>
        </div>
        <div class="item noborder">
            <div class="item-question">General</div>
            <div class="item-ask">
              <p>These terms are governed by the laws of Singapore. It is your responsibility to abide by local laws in relation to the legal usage of the TOP Network website in their local jurisdiction.</p>
              <p>All matters relating to the Website and these Terms of Service and any dispute or claim arising out of or relating to these Terms of Service shall be governed by and construed in accordance with the internal laws of Singapore.</p>
              <p>Any legal suit, action or proceeding arising out of, or related to the Website or these Terms of Service shall be instituted exclusively in the courts of Singapore and we and you consent to personal jurisdiction in those courts.</p>
              <p>These terms control the relationship between us and you. They do not create any third-party beneficiary rights.</p>
              <p>If you do not comply with these terms, and we don’t take action right away, it doesn’t mean that we are giving up any rights that we may have (such as taking action in the future).</p>
              ...
              <p>If you have any feedback or questions regarding these terms, kindly contact us at <a href="mailto:legal@topnetwork.org">legal@topnetwork.org.</a></p>
              <p class="margintop">Telos Foundation</p>
              <p>Dated: 2018/10/9</p>
            </div>
        </div>
      </div>
...
<style lang="scss" scoped>
  .policy{
    ...
    .title{
      background: url('../../assets/images/faq/background.png') no-repeat;
    ...
    .info{
      ...
      padding: 0.53rem 0.4rem  0.53rem 0.4rem;
      font-family:Cera Pro;
      color:rgba(255,255,255,1);
      text-align: left;
      font-size:0.35rem;
      ...
      .item{
        ...
        .item-ask{
          ...
          a{
            color:#CF9A1F;
            border-bottom: 1px solid #CF9A1F;
            padding-bottom: 3px;
          }
        }
      }
